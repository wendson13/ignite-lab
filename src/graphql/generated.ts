...
export type CreateSubscriptionMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', slug: string, title: string, description?: string | null, videoId: string, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null, challenge?: { __typename?: 'Challenge', url: string } | null } | null };
...
export type GetSlugFirstLessonQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSlugFirstLessonQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug: string }> };
...
export const GetSlugFirstLessonDocument = gql`
    query GetSlugFirstLesson {
  lessons(first: 1) {
    slug
  }
}
...
/**
 * __useGetSlugFirstLessonQuery__
 *
 * To run a query within a React component, call `useGetSlugFirstLessonQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSlugFirstLessonQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSlugFirstLessonQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetSlugFirstLessonQuery(baseOptions?: Apollo.QueryHookOptions<GetSlugFirstLessonQuery, GetSlugFirstLessonQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSlugFirstLessonQuery, GetSlugFirstLessonQueryVariables>(GetSlugFirstLessonDocument, options);
      }
export function useGetSlugFirstLessonLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSlugFirstLessonQuery, GetSlugFirstLessonQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSlugFirstLessonQuery, GetSlugFirstLessonQueryVariables>(GetSlugFirstLessonDocument, options);
        }
export type GetSlugFirstLessonQueryHookResult = ReturnType<typeof useGetSlugFirstLessonQuery>;
export type GetSlugFirstLessonLazyQueryHookResult = ReturnType<typeof useGetSlugFirstLessonLazyQuery>;
export type GetSlugFirstLessonQueryResult = Apollo.QueryResult<GetSlugFirstLessonQuery, GetSlugFirstLessonQueryVariables>;